> **Documento archivado y fusionado (Consolidación documental THÖREN, 2026-07-31).** Su contenido técnico reutilizable (kit `catalogTemplates/kit/`) ya está resumido en [`../../product/THOREN_STICKER_BUILDER_COMPONENT.md`](../../product/THOREN_STICKER_BUILDER_COMPONENT.md) §4 — este documento se conserva íntegro como el detalle exhaustivo original, no como fuente activa de trabajo diario.
