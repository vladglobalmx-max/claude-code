...
**Estado:** runtime mínimo completo. Desde Editor 2 hereda selección por click (click selecciona/cambia, Shift-click selecciona múltiple, click en vacío deselecciona), desde Editor 3 hereda movimiento por arrastre integrado con la selección (arrastrar sin click previo selecciona y mueve a la vez), y desde Editor Epic 1 hereda el sistema completo de manipulación (al seleccionar un único object aparecen su bounding box, 8 handles de resize y un handle de rotación) — ver [`@impulso/renderer-konva`](../../packages/renderer-konva/README.md#5-ux-regla-permanente-ux-first-desde-editor-2), sin ningún código adicional en esta app: son capacidades del Renderer, no de este runtime. Sigue sin implementar Toolbar, Sidebar, Zoom, Pan, Inspector, Layers Panel ni Exportaciones.
