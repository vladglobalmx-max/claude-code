> **Documento archivado y fusionado (Consolidación documental THÖREN, 2026-07-31).** Describía, para Sticker Builder como producto independiente, un wizard de usuario de 7 pasos que **no existe en THÖREN 2.0** (`THOREN_VISION_2.md` es explícito: desaparece por completo). La capacidad interna que sí persiste (Preflight, imposición, perfiles de exportación, invocados sin superficie de usuario propia) está resumida en [`../../product/THOREN_STICKER_BUILDER_COMPONENT.md`](../../product/THOREN_STICKER_BUILDER_COMPONENT.md) §8. Se conserva íntegro como referencia histórica del wizard original.
