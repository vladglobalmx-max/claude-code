> **Documento archivado y fusionado (Consolidación documental THÖREN, 2026-07-31).** Su proceso de conversión especificación→`Project` ya está resumido en [`../../product/THOREN_STICKER_BUILDER_COMPONENT.md`](../../product/THOREN_STICKER_BUILDER_COMPONENT.md) §5 — este documento se conserva íntegro como el detalle exhaustivo original, no como fuente activa de trabajo diario.
