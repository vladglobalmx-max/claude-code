...
/**
 * Error boundary para todo el árbol /pedidos (lista, detalle, nuevo,
 * editar) — Next.js usa el error.tsx más cercano al segmento donde ocurrió
 * el error, así que uno solo aquí cubre las cuatro rutas.
 */
