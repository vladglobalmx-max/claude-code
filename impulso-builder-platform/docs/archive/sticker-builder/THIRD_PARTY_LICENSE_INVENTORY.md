> **Documento archivado y fusionado (Consolidación documental THÖREN, 2026-07-31).** Su inventario ya está resumido en [`../../product/THOREN_STICKER_BUILDER_COMPONENT.md`](../../product/THOREN_STICKER_BUILDER_COMPONENT.md) §9 — sigue siendo válido sin cambios, la fusión solo lo hace consultable junto al resto de la documentación técnica del componente interno.
