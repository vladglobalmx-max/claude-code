...
function readForm(formData: FormData) {
  return {
    ...
    requiredBeforeOrder: formData.get("requiredBeforeOrder") === "on",
    requiredBeforeFulfillment: formData.get("requiredBeforeFulfillment") === "on",
...
export async function createCustomFieldDefinition(
  ...
  const { error } = await supabase.from("custom_field_definitions").insert({
    ...
    required_before_order: data.requiredBeforeOrder,
    required_before_fulfillment: data.requiredBeforeFulfillment,
    active: data.active,
...
export async function updateCustomFieldDefinition(
  ...
  const { error } = await supabase
    ...
    .update({
      label,
      required: formData.get("required") === "on",
      required_before_order: formData.get("requiredBeforeOrder") === "on",
      required_before_fulfillment: formData.get("requiredBeforeFulfillment") === "on",
      active: formData.get("active") === "on",
