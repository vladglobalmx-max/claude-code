 ...
 * exclusivo — can_manage_users NUNCA debe llegar hasta aquí (Tipos de
 * producto es configuración de negocio, fuera del alcance de 0046).
 */
export default async function TiposProductoLayout({ children }: { children: React.ReactNode }) {
