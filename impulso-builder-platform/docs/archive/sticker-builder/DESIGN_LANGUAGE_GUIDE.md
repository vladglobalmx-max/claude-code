> **Documento archivado y parcialmente fusionado (Consolidación documental THÖREN, 2026-07-31).** Sus convenciones técnicas de producción (sangrado/área segura/niveles de reducción de iconografía) ya están resumidas en [`../../product/THOREN_STICKER_BUILDER_COMPONENT.md`](../../product/THOREN_STICKER_BUILDER_COMPONENT.md) §6. Sus 6 familias de lenguaje visual, paleta/tipografía/mockup por familia y voz comercial estaban atadas al catálogo comercial de Sticker Builder como producto independiente — descartado tras `THOREN_PRODUCT_DIRECTION.md` (escenario D) — y se conservan aquí únicamente como registro histórico, no como fuente activa.
