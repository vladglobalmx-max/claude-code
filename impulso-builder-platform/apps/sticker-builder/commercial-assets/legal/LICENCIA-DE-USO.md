...
- **Instalar y usar** la aplicación en los equipos que necesites para tu propio uso (personal o de tu negocio).
- **Crear diseños** de stickers con la aplicación, para uso personal o comercial.
- **Exportar y vender** los archivos que generes (PNG, SVG, PDF de impresión) — ver sección 4 sobre derechos de los diseños.
- **Hacer copias de seguridad** de la aplicación y de tus proyectos.
...
Soporte por correo electrónico (ver `commercial-product.json` → `support.email`, o la sección "Soporte" de la documentación de este paquete). Tiempo de respuesta objetivo: 2-3 días hábiles — un objetivo de servicio, no una garantía legal.

## 7. Política de actualizaciones

Tu compra incluye actualizaciones menores de la misma edición sin costo adicional, entregadas como una nueva descarga desde tu historial de compras de Gumroad. Ver la Guía de Actualización y Respaldo para el procedimiento recomendado.
