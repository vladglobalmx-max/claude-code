 ...
 * exclusivo — can_manage_users NUNCA debe llegar hasta aquí (Folios de
 * Cotización es configuración comercial, fuera del alcance de 0046).
 */
export default async function FoliosCotizacionesLayout({ children }: { children: React.ReactNode }) {
