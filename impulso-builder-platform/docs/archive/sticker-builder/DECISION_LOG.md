> **Documento archivado y parcialmente fusionado (Consolidación documental THÖREN, 2026-07-31).** Sus decisiones de ingeniería reutilizables (DEC-001 a DEC-005, DEC-007 a DEC-014) ya están resumidas en [`../../product/THOREN_STICKER_BUILDER_COMPONENT.md`](../../product/THOREN_STICKER_BUILDER_COMPONENT.md) §3. Las decisiones específicas del checkpoint de Beta Comercial del catálogo (DEC-006, DEC-015, DEC-016) quedan sin objeto tras `THOREN_PRODUCT_DIRECTION.md` (escenario D). Este log se conserva íntegro como el detalle exhaustivo original (alternativas consideradas, justificación completa de cada decisión), no como fuente activa de reglas de decisión de producto — esa función es de `THOREN_DECISION_CRITERIA.md`.
