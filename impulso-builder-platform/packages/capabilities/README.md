...
> Capa 4 de la arquitectura comercial (ver [ADR-0026](../../docs/adr/0026-commercial-platform-boundaries.md)). Nace en Fase 4.2 (Commercial MVP) como el primer `CapabilityProvider` REAL — hasta esta fase, `CapabilityProvider` era solo una interfaz en `@impulso/commercial-schema`, sin ninguna implementación.
