...
/** Cubre /configuracion/usuarios, /nuevo y /[id]/editar — no afecta Catálogo ni Tipos de producto. */
export default function UsuariosError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
    console.error(error);
  }, [error]);
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      <div className="flex flex-col items-center gap-3 rounded-xl border border-danger/30 bg-danger/5 px-6 py-12 text-center">
        ...
        <p className="text-sm font-medium text-ink">No se pudo cargar Usuarios y accesos</p>
