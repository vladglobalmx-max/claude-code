# Cómo actualizar y respaldar tus proyectos — Impulso Sticker Builder Professional

## Cómo actualizar Impulso

Impulso Sticker Builder Professional **no se actualiza solo** — no hay un "auto-actualizador" en esta versión. Actualizar es siempre una acción manual tuya:

1. Vuelve a la página de "Biblioteca" de tu compra en Gumroad (el mismo lugar donde descargaste Impulso la primera vez).
...
3. Impulso valida el archivo y, si es correcto, crea un nuevo proyecto en tu biblioteca con todo su contenido (diseño + imágenes).

**¿Cuándo usar esto?**
- Antes de actualizar Impulso, si quieres una copia de seguridad extra.
- Si vas a cambiar de computadora o reinstalar tu navegador.
- Si quieres enviarle un proyecto a otra persona que también use Impulso.
